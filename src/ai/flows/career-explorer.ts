...
2.  **Specific Roles (specificRoles):** A comprehensive list of distinct and concrete job titles or specializations that exist within this broader field. Provide as many relevant roles as possible. For example, if the user asks about "Marketing," you might list roles like "SEO Specialist," "Content Marketing Manager," "Social Media Manager," "PPC Analyst", "Marketing Automation Specialist", etc.
...
*   If the input is "Designing," the \`specificRoles\` should be a list like: ["Graphic Design", "UI/UX Design", "Interior Design", "Fashion Design", "Product Design", "Industrial Design", "Animation"].
*   If the input is "Business," the \`specificRoles\` should be a list like: ["Finance", "Marketing", "Human Resources", "Operations Management", "Entrepreneurship", "Sales", "Business Analyst"].
